...
action.remakeDIV = function (id) {
    ...
    switch(id){
        ...
        case 'avatarImage':
            ...
            div.style.backgroundImage = 'url("file:///var/mobile/Library/iWidgets/RAMADANinBlue/images/ramaddd.png?'+ Math.floor((Math.random() * 1000) + 1) +' ")';
