...
function setSpecificStyles(div, id){
    ...
    switch (id) {
        ...
        case 'avatarImage':
            ...
            div.style.backgroundImage = 'url("file:///var/mobile/Library/iWidgets/22SBG/images/IMG_3033.png?' + Math.floor((Math.random() * 1000) + 1) + ' ")';
            div.style.backgroundSize = 'contain';
            div.style.backgroundRepeat = 'no-repeat';
            break;
