...
var stockBundles = ['com.apple.mobilephone','com.apple.mobilemail', 'com.apple.MobileSMS', 'com.apple.Music', 'com.apple.mobilesafari', 'com.apple.mobilenotes', 'com.apple.Preferences', 'com.apple.mobiletimer', 'com.apple.stocks', 'com.apple.weather', 'com.apple.Maps', 'com.apple.reminders', 'com.apple.Health', 'com.apple.mobileslideshow', 'com.apple.AppStore', 'com.apple.facetime', 'com.apple.calculator', 'com.apple.compass', 'com.apple.news', 'com.apple.VoiceMemos', 'com.apple.mobilecal'];
 ...
 action.remakeDIV = function (id) {
     ...
     if (id !== 'flipclock' && id !== 'songalbumnohide' && id !== 'songartistnohide' && id !== 'songtitlenohide' && id !== 'songalbum' && id !== 'songartist' && id !== 'songtitle' && id !== 'quote1ReadMore' && id !== 'quote1' && id !== 'batterypie' && id.substring(0, 7) != 'fpplace' && id.substring(0, 6) !== 'bundle' && id.substring(0, 11) !== 'customPanel' && id !== 'hueLights' && id !== 'hueGroups' && id.substring(0, 9) !== 'customDiv' && id !== 'avatarImage' && id !== 'respring' && id !== 'sleep' && id !== 'timer' && id !== 'icon' && id !== 'day1icon' && id !== 'day2icon' && id !== 'day3icon' && id !== 'day4icon' && id !== 'day5icon' && id !== 'songalbumArtnohide' && id !== 'songalbumArt' && id !== 'searchicon' && id !== 'searchtext' && id !== 'unlock' && id !== 'flashlight' && id !== 'playmusic' && id !== 'nextmusic' && id !== 'prevmusic' && id !== 'playmusichide' && id !== 'nextmusichide' && id !== 'prevmusichide' && id.substring(0, 4) !== 'text' && id.substring(0, 3) !== 'box' && id.substring(0, 3) !== 'tri' && id.substring(0, 3) !== 'app' && id !== 'hour1icon' && id !== 'hour2icon' && id !== 'hour3icon' && id !== 'hour4icon' && id !== 'hour5icon') {
         div.innerText = "*";
     ...
     switch(id){
         ...
         case 'avatarImage':
             ...
             div.style.backgroundImage = 'url("file:///var/mobile/Library/iWidgets/GoldBack020/images/IMG_2531.png?'+ Math.floor((Math.random() * 1000) + 1) +' ")';
             div.style.backgroundSize = 'contain';
             div.style.backgroundRepeat = 'no-repeat';
         break;
 ...
 action.createIconElementIfNeeded = function(key, createdDiv){
     if (key === 'icon' || key === 'day1icon' || key === 'day2icon' || key === 'day3icon' || key === 'day4icon' || key === 'hour1icon' || key === 'hour2icon' || key === 'hour3icon' || key === 'hour4icon' || key === 'hour5icon') {
        var img = document.createElement('img');
         img.className = 'iconClass' + key;
         img.id = 'iconDiv' + key;
         //set opacity to 0 until image is loaded
         //image loaded in mainLoop.js
         img.style.opacity = 0;
     ...
     Object.keys(placedElements).forEach(function (key) {
         if (placedElements[key].type == 'widget') {
             ...
             try{
                 ...
                 if(createdDiv && createdDiv.id.indexOf('Panels') > -1){
