...
action.remakeDIV = function (id) {
    ...
    switch(id){
        ...
        case 'avatarImage':
            ...
            div.style.backgroundImage = 'url("file:///var/mobile/Digit19/var/mobile/Library/iWidgets/Digit19/images/digit.png?'+ Math.floor((Math.random() * 1000) + 1) +' ")';
...
action.replaceElements = function () {
    ...
    // if (action.containsWeather === true) {
    //     setTimeout(function () {
    ...
    if (localStorage.placedElements) {
        ...
        if (this.savedElements.placedElements) {
           // try {
            ...
            //} catch (err) {
              //  alert("LockPlus: main.js load storage" + err);
            //}
        }
    } else {
        setTimeout(function () {
